...
const NameFilter = () => {
  ...
  const data = [
    {
        "id": 1,
        "imageUrl": "https://robohash.org/set_set5/35?size200x200",
        "name": "CeeJay Graham",
        "username": "Bret",
        "email": "cee@gmail.com",
        "address": {
    ...
    {  
        "id": 2,
        "imageUrl": "https://robohash.org/set_set5/33?size200x200",
        "name": "Mary Howell",
        "username": "Antonette",
    ...
    { "id": 3,
    "imageUrl": "https://robohash.org/set_set5/14?size200x200",
    "name": "Clement Manji",
    "username": "Samantha",
    ...
    { "id": 4,
    "imageUrl": "https://robohash.org/set_set5/?size200x200",
    "name": "Patricia John",
    "username": "Karianne",
    ...
    { "id": 5,
    "imageUrl": "https://robohash.org/set_set5/7?size200x200",
    ...
    { "id": 6,
    "imageUrl": "https://robohash.org/set_set5/8?size200x200",
    "name": "Victor John",
    ...
    { "id": 7,
    "imageUrl": "https://robohash.org/set_set5/9?size200x200",
    "name": "Kurtis Rinret",
    ...
    { "id": 8,
    "imageUrl": "https://robohash.org/set_set5/2?size200x200",
    "name": "Nicholas Licto",
    ...
    { "id": 9,
    "imageUrl": "https://robohash.org/set_set5/10?size200x200",
    ...
    { "id": 10,
    "imageUrl": "https://robohash.org/set_set5/16?size200x200",
    "name": "Mike Shola",
  ...
  return (
    <div className="flex flex-col items-center h-full w-screen bg-slate-300" >
      <input className="border border-gray-300 bg-white-50 hover:shadow-xl rounded-md px-4 py-2 focus:outline-none focus:border-blue-300"
        type="text"
        placeholder="Search..."
        value={searchTerm}
